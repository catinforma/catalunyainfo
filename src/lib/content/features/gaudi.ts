...
export const GAUDI: FeatureArticle = {
  ...
  categoryKey: "culture",
  heroKey: "gaudi-desconegut-modernisme-catalunya",
  secondaryKey: "gaudi-arcs-mao-modernisme",
  heroAlt: {
    ca: "Detall d'arquitectura modernista catalana inspirada en l'obra de Gaudí",
    es: "Detalle de arquitectura modernista catalana inspirada en la obra de Gaudí",
    en: "Catalan modernist architectural detail in the spirit of Gaudí's work",
  },
  heroCaption: {
    ca: "Imatge representativa d'arquitectura modernista catalana; no correspon a cap monument concret. Il·lustració generada amb intel·ligència artificial.",
    es: "Imagen representativa de arquitectura modernista catalana; no corresponde a ningún monumento concreto. Ilustración generada con inteligencia artificial.",
    en: "Representative image of Catalan modernist architecture; it does not depict any specific monument. Illustration generated with artificial intelligence.",
  },
  secondaryAlt: {
    ca: "Arcs de maó d'inspiració modernista",
    es: "Arcos de ladrillo de inspiración modernista",
    en: "Modernist-inspired brick arches",
  },
  secondaryCaption: {
    ca: "Imatge representativa d'arcs de maó modernistes; no correspon a cap edifici concret. Il·lustració generada amb intel·ligència artificial.",
    es: "Imagen representativa de arcos de ladrillo modernistas; no corresponde a ningún edificio concreto. Ilustración generada con inteligencia artificial.",
    en: "Representative image of modernist brick arches; it does not depict any specific building. Illustration generated with artificial intelligence.",
  },
  sources: [
