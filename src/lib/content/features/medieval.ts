...
export const MEDIEVAL: FeatureArticle = {
  ...
  heroKey: "medieval-hero",
  secondaryKey: "medieval-second",
  heroAlt: {
    ca: "El pont medieval de Besalu sobre el riu Fluvia",
    es: "El puente medieval de Besalu sobre el rio Fluvia",
    en: "The medieval bridge of Besalu over the river Fluvia",
  },
  heroCaption: {
    ca: "El pont medieval de Besalu, sobre el Fluvia.",
    es: "El puente medieval de Besalu, sobre el Fluvia.",
    en: "The medieval bridge at Besalu, over the river Fluvia.",
  },
  secondaryAlt: {
    ca: "La muralla de Montblanc, a la Conca de Barbera",
    es: "La muralla de Montblanc, en la Conca de Barbera",
    en: "The town walls of Montblanc, in the Conca de Barbera",
  },
  secondaryCaption: {
    ca: "La muralla de Montblanc, un dels perimetres fortificats mes complets de Catalunya.",
    es: "La muralla de Montblanc, uno de los perimetros fortificados mas completos de Cataluna.",
    en: "Montblanc's walls, one of the most complete fortified perimeters in Catalonia.",
  },
  sources: [
