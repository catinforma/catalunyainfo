...
export const RAINY: FeatureArticle = {
  ...
  categoryKey: "culture",
  heroKey: "plans-pluja-catalunya-museus-patrimoni",
  secondaryKey: "dia-pluja-catalunya-coves-museus",
  heroAlt: {
    ca: "Interior d'un espai patrimonial català en un dia de pluja",
    es: "Interior de un espacio patrimonial catalán en un día de lluvia",
    en: "Inside a Catalan heritage building on a rainy day",
  },
  heroCaption: {
    ca: "Imatge representativa d'un espai patrimonial interior. Il·lustració generada amb intel·ligència artificial.",
    es: "Imagen representativa de un espacio patrimonial interior. Ilustración generada con inteligencia artificial.",
    en: "Representative image of an indoor heritage space. Illustration generated with artificial intelligence.",
  },
  secondaryAlt: {
    ca: "Galeria subterrània visitable a Catalunya",
    es: "Galería subterránea visitable en Cataluña",
    en: "An underground gallery open to visitors in Catalonia",
  },
  secondaryCaption: {
    ca: "Imatge representativa d'una galeria subterrània; no correspon a cap cova concreta. Il·lustració generada amb intel·ligència artificial.",
    es: "Imagen representativa de una galería subterránea; no corresponde a ninguna cueva concreta. Ilustración generada con inteligencia artificial.",
    en: "Representative image of an underground gallery; it does not depict any specific cave. Illustration generated with artificial intelligence.",
  },
  sources: [
