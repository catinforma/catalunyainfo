...
export const TRAPS: FeatureArticle = {
  ...
  categoryKey: "cities",
  heroKey: "barcelona-sense-trampes-turistes",
  secondaryKey: "barcelona-barris-mercats-alternatives",
  heroAlt: {
    ca: "Carrer de Barcelona fora dels circuits més transitats",
    es: "Calle de Barcelona fuera de los circuitos más transitados",
    en: "A Barcelona street away from the busiest tourist routes",
  },
  heroCaption: {
    ca: "Imatge representativa d'un carrer de Barcelona. Il·lustració generada amb intel·ligència artificial.",
    es: "Imagen representativa de una calle de Barcelona. Ilustración generada con inteligencia artificial.",
    en: "Representative image of a Barcelona street. Illustration generated with artificial intelligence.",
  },
  secondaryAlt: {
    ca: "Mercat de barri a Barcelona",
    es: "Mercado de barrio en Barcelona",
    en: "A neighbourhood market in Barcelona",
  },
  secondaryCaption: {
    ca: "Imatge representativa d'un mercat de barri; no correspon a cap mercat concret. Il·lustració generada amb intel·ligència artificial.",
    es: "Imagen representativa de un mercado de barrio; no corresponde a ningún mercado concreto. Ilustración generada con inteligencia artificial.",
    en: "Representative image of a neighbourhood market; it does not depict any specific market. Illustration generated with artificial intelligence.",
  },
  sources: [
